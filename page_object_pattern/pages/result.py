...
class DuckDuckGoResultPage:
    ...
    def search_geo_in_wiki(self):
        self.browser.find_element(*self.PHRASE_RESULTS('en.wikipedia.org/')).click()
        geo_search_result = self.browser.find_elements(By.CLASS_NAME, "geo-inline")
        return len(geo_search_result)
